 ...
 * 
 */
@WebServiceClient(name = "PersonaServiceImplService", targetNamespace = "http://servicio/", wsdlLocation = "http://pietrodeocre-desktop:8080/PersonaServiceImplService/PersonaServiceImpl?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://pietrodeocre-desktop:8080/PersonaServiceImplService/PersonaServiceImpl?wsdl");
