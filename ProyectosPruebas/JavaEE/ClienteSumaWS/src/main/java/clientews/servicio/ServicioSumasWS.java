 ...
 * 
 */
@WebService(name = "ServicioSumasWS", targetNamespace = "http://beans/")
@XmlSeeAlso({
    ObjectFactory.class
})
public interface ServicioSumasWS {
    ...
    @Action(input = "http://beans/ServicioSumasWS/sumarRequest", output = "http://beans/ServicioSumasWS/sumarResponse")
    public int sumar(
