 ...
 * 
 */
@WebServiceClient(name = "ServicioSumarImplService", targetNamespace = "http://beans/", wsdlLocation = "http://pietrodeocre-desktop:8080/ServicioSumarImplService/ServicioSumarImpl?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://pietrodeocre-desktop:8080/ServicioSumarImplService/ServicioSumarImpl?wsdl");
     ...
     * 
     * @return
     *     returns ServicioSumasWS
     */
    @WebEndpoint(name = "ServicioSumarImplPort")
    public ServicioSumasWS getServicioSumarImplPort() {
        return super.getPort(new QName("http://beans/", "ServicioSumarImplPort"), ServicioSumasWS.class);
    }
     ...
     */
    @WebEndpoint(name = "ServicioSumarImplPort")
    public ServicioSumasWS getServicioSumarImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://beans/", "ServicioSumarImplPort"), ServicioSumasWS.class, features);
    }
